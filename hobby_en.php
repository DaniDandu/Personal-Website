    ...
    <nav class="navbar navbar-expand-sm navbar-dark">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item text-center">
            <a class="nav-link active" href="hobby_en.html">
          ...
          <li class="nav-item">
            <div class="ro-flag">
              <a title="Romanian" class="nav-link" href="hobby.html">
          ...
          <li class="nav-item">
            <div class="en-flag">
              <a title="English" class="nav-link" href="hobby_en.html">
                <button type="button" class="btn" data-bs-toggle="popover">
    ...
    <div class="container">
      <div class="row">
        <div class="text col-md-6">
          <p style="font-size: 20px; font-family:Verdana;"><b>Hobbies</b></p><br>
          <p>I love driving, especially on the long road. I think it is
            very reassuring. I love listening to music and going out with friends. Most of all, I can say that I like it
            driving, especially when listening to your favorite songs in the car.</p>
          
        </div>
        <div class="col-md-6 text-center ">
            <div class="containerl">
                <div class="lightbox-gallery">
                  <a href="img/condus.jpg">
                    <img src="img/condus.jpg" class="img-fluid" style="height: 200px; width: 300px;">
                  </a>
                  <a href="img/muzica2.jpg">
                    <img src="img/muzica2.jpg" class="img-fluid" style="height: 200px; width: 300px;">
                  </a>
                  <a href="img/muzica1.jpg">
                    <img src="img/muzica1.jpg" class="img-fluid" style="height: 200px; width: 300px;">
                  </a>
                  <a href="img/condus2.jpg">
                    <img src="img/condus2.jpg" class="img-fluid" style="height: 200px; width: 300px;">
                  </a>
                </div>
            </div>
        </div>
